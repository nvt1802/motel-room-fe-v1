...
export default function AccountManagement(props) {
    ...
    const renderRowAccount = () => {
        var elements = props.accountAvailableData.map((value, index) => {
            return (
                <tr key={value.accountId} className="text-center" >
                    ...
                    <td>{(PAGE_SIZE * props.page + index + 1).toString()}</td>
                    ...
                    {/* <td>
                        ...
                        {value.accountId !== props.account.accountId ? (
                ...
                <fieldset style={{ border: '1px black solid' }}>
                    ...
                    <div className="ml-2 mr-2 mt-2">
                        ...
                        <table className="table table-sm table-bordered table-hover">
                            ...
                            <tbody>
                                {accountAvailableData.length > 0 ? renderRowAccount() : null}
                            </tbody>
                        </table>
                        <AccountPagination totalPage={totalPage} handleClickPagination={handleClickPagination} deleted={refresh} />
                    </div>
                </fieldset>
            </div>
        }
