...
export default  function SignUp(props) {
    ...
    const getDistrictByProvinceId = (e) => {
    ...
    return (<>
                    ...
                    <div className="row">
                        <div className="form-bounded col-sm-12 col-md-6 pl-0">
                            <select ref={register({
                                ...
                                className="form-control cursor" id="province" name="province" style={{ borderColor: 'rgb(221, 221, 221)' }}>
                                <option value={-1}>Tỉnh/Thành phố</option>
                                {renderOptionProvince()}
                            </select>
                            <label htmlFor="province" style={{ top: '-10px', color: 'rgb(102, 102, 102)', fontSize: '12px', fontStyle: 'italic' }}>
                        ...
                        <div className="form-bounded col-sm-12 col-md-6 px-0">
                            ...
                            })} className="form-control cursor" id="district" name="district" style={{ borderColor: 'rgb(221, 221, 221)' }}>
                                <option value={-1}> Quận/Huyện</option>
                                {renderOptionDistrict()}
                            </select>
                            <label htmlFor="district" style={{ top: '-10px', color: 'rgb(102, 102, 102)', fontSize: '12px', fontStyle: 'italic' }}>
        ...
        {signUpSuccess === true ? <NotificationModal closeModal={closeModalNotification} history={props.history} /> : null}
    </>
    )
}